...
import 'package:fastdelivery_multivendor_driver/feature/chat/widgets/search_field_widget.dart';
...
import 'package:fastdelivery_multivendor_driver/helper/user_type_helper.dart';
...
import 'package:fastdelivery_multivendor_driver/common/widgets/custom_ink_well_widget.dart';
import 'package:fastdelivery_multivendor_driver/common/widgets/custom_snackbar_widget.dart';
import 'package:fastdelivery_multivendor_driver/common/widgets/paginated_list_view_widget.dart';
      ...
      body: GetBuilder<ChatController>(builder: (chatController) {
        ...
        return Padding(
          ...
          child: Column(children: [
            ...
            Expanded(
              child: (conversation0 != null && conversation0.conversations != null) ? conversation0.conversations!.isNotEmpty ? RefreshIndicator(
                onRefresh: () async {
