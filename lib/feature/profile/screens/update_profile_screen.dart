...
import 'package:fastdelivery_multivendor_driver/feature/profile/domain/models/profile_model.dart';
...
import 'package:fastdelivery_multivendor_driver/common/widgets/custom_text_form_field.dart';
...
class _UpdateProfileScreenState extends State<UpdateProfileScreen> {
  ...
  void _updateProfile(ProfileController profileController) async {
    ...
    if (profileController.profileModel!.fName == firstName &&
      ...
      bool isSuccess = await profileController.updateUserInfo(updatedUser, Get.find<AuthController>().getUserToken());
      if(isSuccess) {
